...
namespace kursWorkBD {
    ...
    public partial class restoranDataSet : global::System.Data.DataSet {
        ...
        public partial class PositionsDataTable : global::System.Data.TypedTableBase<PositionsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PositionsRow AddPositionsRow(string position, double salary) {
        ...
        public partial class PositionsRow : global::System.Data.DataRow {
            ...
            public double salary {
                get {
                    return ((double)(this[this.tablePositions.salaryColumn]));
                }
                set {
...
namespace kursWorkBD.restoranDataSetTableAdapters {
    ...
    public partial class PositionsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Positions] WHERE (([id] = @Original_id) AND ([position] = @Ori" +
                "ginal_position) AND ([salary] = @Original_salary))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Positions] ([position], [salary]) VALUES (@position, @salary);" +
                "\r\nSELECT id, position, salary FROM Positions WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Positions] SET [position] = @position, [salary] = @salary WHERE (([" +
                "id] = @Original_id) AND ([position] = @Original_position) AND ([salary] = @Origi" +
                "nal_salary));\r\nSELECT id, position, salary FROM Positions WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::kursWorkBD.Properties.Settings.Default.restoranConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, position, salary FROM dbo.Positions";
        ...
        public virtual int Fill(restoranDataSet.PositionsDataTable dataTable) {
        ...
        public virtual restoranDataSet.PositionsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            restoranDataSet.PositionsDataTable dataTable = new restoranDataSet.PositionsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(restoranDataSet.PositionsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_position, double Original_salary) {
        ...
        public virtual int Update(string position, double salary, int Original_id, string Original_position, double Original_salary, int id) {
            if ((position == null)) {
                throw new global::System.ArgumentNullException("position");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string position, double salary, int Original_id, string Original_position, double Original_salary) {
            return this.Update(position, salary, Original_id, Original_position, Original_salary, Original_id);
        }
    }
