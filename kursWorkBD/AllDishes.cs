...
namespace kursWorkBD
{
    public partial class AllDishes : Form
    {
        ...
        public AllDishes(SqlConnection con)
        {
            InitializeComponent();
            this.con = con;
        }

        private void AllDishes_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string query = "exec load_all_orders;";
                ...
                for (int k = 0; k < dishes.Count; ++k)
                {
                    ...
                    data[data.Count - 1][1] = amountes[k].ToString();
                    data[data.Count - 1][2] = prices[k].ToString();
                }
                reader.Close();
